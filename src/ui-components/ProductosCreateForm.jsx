...
export default function ProductosCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setCantidadStock(initialValues.cantidadStock);
    setValoracionPromedio(initialValues.valoracionPromedio);
    setErrors({});
  };
  const validations = {
    nombre: [],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new Productos(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "ProductosCreateForm")}
      {...rest}
    >
      <TextField
        label="Nombre"
