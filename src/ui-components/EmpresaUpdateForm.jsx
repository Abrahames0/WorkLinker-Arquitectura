...
export default function EmpresaUpdateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setCalleEmpresa(cleanValues.calleEmpresa);
    setNumeroEmpresa(cleanValues.numeroEmpresa);
    setCiudadEmpresa(cleanValues.ciudadEmpresa);
    setCodigoPostalEmpresa(cleanValues.codigoPostalEmpresa);
    setEstadoEmpresa(cleanValues.estadoEmpresa);
    setPaisEmpresa(cleanValues.paisEmpresa);
    setErrors({});
  };
