...
export default function CategoriasUpdateForm(props) {
  const {
    id: idProp,
    categorias: categoriasModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  const resetStateValues = () => {
    ...
    setProductos(cleanValues.productos);
    setErrors({});
  };
  const [categoriasRecord, setCategoriasRecord] =
    React.useState(categoriasModelProp);
  React.useEffect(() => {
    ...
    >
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || categoriasModelProp)}
